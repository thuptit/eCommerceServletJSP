<%-- 
    Document   : foot
    Created on : Dec 18, 2021, 11:07:59 PM
    Author     : thunv
--%>
...
<script type="text/javascript">
    $(document).ready( () => {
        let username = sessionStorage.getItem('usernameAdmin');
        if(username) {
            let rawAccount = "<i class='fas fa-user'></i> Xin chào " + username;
            $('#navbarDropdown').html(rawAccount)
        }
    })
</script>
</body>
